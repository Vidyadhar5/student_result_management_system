...
def get_students(request):
    ...
    for student in students:
        data_small={"id":student.admin.id, "name":student.admin.first_name+" "+student.admin.last_name, "usn":student.admin.username}
...
def save_attendance_data(request):
    ...
    try:
        ...
        print("ERROR IN SAVE ATTENDANCE: ", str(e))
...
def staff_add_result_save(request):
    if request.method != "POST":
        ...
        try:
            ...
            print("ERROR IN ADD RESULT:", str(e))
